...
public interface OpsProxy {
	 ...
	 * @param data cpointer to user date passed to fuse_lowlevel_new
	 * @param conn cpointer to fuse_conn_info struct
	 */
	 ...
	 * @param data cpointer ot user data passed to fuse_lowlevel_new
	 */
	 ...
	 *
	 * The filesystem may ignore forget calls, if the inodes don't need
	 * to have a limited lifetime.
	 *
	 * On unmount it is not guaranteed, that all referenced inodes will
	 * receive a forget message.
	 *
	 * @param req request handle
	 ...
	 * @param req request handle
	 * @param ino inode number
	 * @param fi file information or c-nullpointer
	 */
	 ...
	 * kernel versions 2.6.15 or later, the fi->fh will contain the value set
	 * by the open method or will be undefined if the open method didn't set
	 * any value. Otherwise (not ftruncate call, or kernel version earlier
	 * than 2.6.15) the fi parameter will be NULL.
	 *
	 * @param req request handle
	 * @param ino inode number
	 ...
	 * @param rdev device number (only when create device)
	 */
	 ...
	 * @param req request handle
 	 * @param parent inode number of the parent directory
	 * @param name name of the inode to remove
	 */
	 ...
	 * @param link the contents of the symbolic link
 	 * @param parent inode number of the parent directory
	 * @param name name of the inode to create
	 */
	 ...
	 */
    public void rename(long req, long parent, String name,
	 ...
	 *
	 * @param req request handle
	 * @param parent the old inode number
	 * @param newparent inode number of the new parent directory
	 ...
	 * are available in fi->flags.
	 *
	 * Filesystem may store an arbitrary file handle (pointer, index, etc)
	 * in fi->fh, and use this in other all other file operations
	 ...
	 * may set in fi, to change the way the file is opened.
	 ...
	 * Read data
	 *
	 * Read should send exactly the number of bytes requested except on EOF
	 * or error, otherwise the rest of the data will be substituted with zeroes.
	 * An exception to this is when the file has been opened in 'direct_io'
	 * mode, in which case the return value of the read system call will
